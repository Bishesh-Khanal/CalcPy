...
function add_windoww() {
  ...
  stat_counterr += 1;
    ...
    html ='<tr id = "row-'+stat_counterr+'"class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">\
            <td class="px-3 py-3">\
              <input type="text" id="y'+stat_counterr+'" class="block w-full py-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">\
            </td>\
           <td class="px-3 py-3">\
              <input type="text" id="x'+stat_counterr+'" class="block w-full py-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">\
           </td>\
           <td class="px-3 py-3">\

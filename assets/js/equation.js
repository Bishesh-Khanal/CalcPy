...
let simul_radio_btns = document.querySelectorAll(
  "input[name = 'simul-inline-radio-group']"
);

let generate_simul_form = () => {
  let simul_selected = document.querySelector(
    "input[name = 'simul-inline-radio-group']:checked"
  );
  ...
  if (val == "1-val") {
    ...
    form_html =
      '<div id = "1-var-eqns" class = "grid rows gap-2">\
    ...
    ans_html =
      ' <div id = "1-val-ans" class="max-w-sm px-2 py-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 grid">\
  ...
  if (val == "2-val") {
    ...
    form_html =
      '<div id = "2-var-eqns" class = "grid rows gap-2">\
    ...
    ans_html =
      ' <div id = "2-val-ans" class="max-w-sm px-2 py-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 grid">\
                            <div class="values m-auto">\
                                <span>\
                                    <span class="text-base variable">x</span>\
                                    <span class="text-base">=</span>\
  ...
  if (val == "3-val") {
    ...
    form_html =
      '<div id = "3-var-eqns" class = "grid rows gap-2">\
    ...
    ans_html =
      ' <div id = "3-val-ans" class="max-w-sm px-2 py-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 grid">\
                            <div class="values m-auto">\
                                <span>\
                                    <span class="text-base variable">x</span>\
                                    <span class="text-base">=</span>\
  ...
  if (val == "4-val") {
    ...
    form_html =
      '<div id = "4-var-eqns" class = "grid rows gap-2">\
    ...
    ans_html =
      ' <div id = "4-val-ans" class="max-w-sm px-2 py-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 grid">\
                        <div class="values m-auto">\
                            <span>\
                                <span class="text-base variable">x</span>\
                                <span class="text-base">=</span>\
...
function toast_generator(message) {
  ...
  var html =
    '<div id="toast-bottom-right" class="fixed flex items-center w-full max-w-xs p-4 space-x-4 text-gray-500 bg-white divide-x divide-gray-200 rounded-lg shadow right-5 bottom-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert"> \
                <div class="text-sm font-normal text-rose-400 "> <i class="bx bxs-radiation text-rose-600"></i> ' +
    message +
    " </div>\
                </div>";
...
simul_calc_btn.addEventListener("click", function () {
  ...
  let simul_var_num = document.querySelector(
    "input[name = 'simul-inline-radio-group']:checked"
  ).value;
...
const poly_radio_btns = document.querySelectorAll(
  "input[name = 'poly-inline-radio-group']"
);
...
let generate_poly_form = () => {
  let poly_selected = document.querySelector(
    "input[name = 'poly-inline-radio-group']:checked"
  ).value;
  ...
  if (poly_selected == "2-deg") {
    ...
    ans_html =
      '<div class="max-w-sm px-2 py-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 grid">\
                        <div class="values m-auto">\
                            <span>\
                                <span class="text-base variable">x</span>\
                                <span class="text-base">=</span>\
  ...
  if (poly_selected == "3-deg") {
    ...
    ans_html =
      '<div class="max-w-sm p-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 grid">\
                    <div class="values m-auto">\
                        <span>\
                            <span class="text-base variable">x</span>\
                            <span class="text-base">=</span>\
...
poly_solve_btn.addEventListener("click", function () {
  ...
  if (poly_selected == "2-deg") {
    ...
    if (!number_validator(a) || !number_validator(b) || !number_validator(c)) {
      ...
      setTimeout(function () {
        document.querySelector("#toast-bottom-right").remove();
      }, 3000);
      return;
    }
